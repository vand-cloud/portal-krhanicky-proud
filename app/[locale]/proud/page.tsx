...
import { getProudPage, getCandidates } from "@/lib/sanity/fetch";
    ...
    <div className="mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
      <header className="max-w-3xl">
        <p className="eyebrow mb-3">
          {page?.eyebrow ?? "Sdružení nezávislých občanů"}
        </p>
      ...
      <ProudHighlights
        eyebrow={page?.highlightsEyebrow}
