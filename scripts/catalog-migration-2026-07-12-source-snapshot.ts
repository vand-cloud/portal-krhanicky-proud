// Frozen snapshot of content/entries.ts as it stood right before the
// 2026-07-12 Sanity migration (git show HEAD:content/entries.ts at the time).
// content/entries.ts itself lost its events[]/directory[]/entries export in
// that migration (data now lives in Sanity, fetched via
// lib/sanity/catalog.ts) -- this file exists solely so
// migrate-catalog-2026-07-12.ts stays runnable/typecheckable as a permanent
// audit-trail record of what was migrated, matching the convention of the
// other scripts/sync-*.ts one-shot scripts in this repo. Not imported by
// anything outside that one migration script.
//
...
const events: Entry[] = [
  ...
  // ─── NOVÉ ZÁZNAMY — Firecrawl deep-search 2026-07-12 (cache mining + živý scrape, viz staging/harvest-2026-07-12.json) ───
  {
    id: "evt-pohadky-na-hrade-jak-zlatnik-ke-stesti-prisel",
    type: "akce",
    slug: "pohadky-na-hrade-jak-zlatnik-ke-stesti-prisel",
    title: "Pohádky na hradě: Jak zlatník ke štěstí přišel",
    description:
      "Loutkové představení pod divadelní lipou za muzeem, vhodné pro děti i dospělé. Vstupné 50 Kč, děti do 3 let zdarma. Při nepříznivém počasí se představení přesouvá do galerie muzea.",
    href: "/akce/pohadky-na-hrade-jak-zlatnik-ke-stesti-prisel",
    website: "http://www.hradtynec.cz/",
    lat: 49.8369,
    lng: 14.5949,
    address: "Areál hradu, Týnec nad Sázavou",
    startedAt: "2026-07-12T17:00:00Z",
    category: "deti-rodina",
    subcategory: "detska-divadla",
    tags: ["pro-deti", "pod-strechou", "tradice"],
    status: "approved",
    trustLevel: "scraped",
    organizer: "Kulturní centrum Týnec",
  ...
  {
    id: "evt-vystava-obrazu-magdy-hanove-pysely",
    type: "akce",
    slug: "vystava-obrazu-magdy-hanove-pysely",
    title: "Výstava obrazů Magdy Hánové: Síla je v jemnosti",
    description:
      "Výstava obrazů Magdy Hánové v Kulturním a informačním centru Pyšely. Zahájení 18. 6. 2026 od 18 hodin, výstava potrvá do 17. 7. 2026. Navštívit ji lze v otevírací době centra.",
    href: "/akce/vystava-obrazu-magdy-hanove-pysely",
    lat: 49.8525,
    lng: 14.4817,
    address: "Náměstí T. G. Masaryka 4, Pyšely",
    startedAt: "2026-06-18T18:00:00Z",
    endedAt: "2026-07-17T17:00:00Z",
    category: "kultura",
    subcategory: "vystavy",
    tags: ["tradice", "pod-strechou"],
    status: "approved",
    trustLevel: "scraped",
  },
  {
    id: "evt-ozivly-stredovek-beneficni-festival-zlenice",
    type: "akce",
    slug: "ozivly-stredovek-beneficni-festival-zlenice",
    title: "Oživlý středověk: benefiční festival",
    description:
      "Celodenní oslava středověkých řemesel, živé historie a hudby na hradě Zlenice. Součástí je tržiště tradičních řemesel, hudební odpoledne a večerní program s kapelami Žniva, Luneris a Deloraine. Vstupenky lze koupit online.",
    href: "/akce/ozivly-stredovek-beneficni-festival-zlenice",
    lat: 49.895,
    lng: 14.73,
    address: "Hrad Zlenice, Lštění",
    startedAt: "2026-07-18T10:00:00Z",
    category: "kultura",
    subcategory: "festivaly",
    tags: ["tradice", "venku", "pro-skupiny"],
    status: "approved",
    trustLevel: "scraped",
    organizer: "Farnost Sázava",
  },
  {
    id: "evt-historicky-serm-pani-z-kolina-jemniste",
    type: "akce",
    slug: "historicky-serm-pani-z-kolina-jemniste",
    title: "Historický šerm: Páni z Kolína",
    description:
      "Mušketýrské vystoupení, výcvik halapartníků a pikenýrů a kostýmové stafáže historické skupiny Páni z Kolína v zámeckých zahradách Jemniště. Vstup lze spojit s prohlídkou parku a minizvěřince.",
    href: "/akce/historicky-serm-pani-z-kolina-jemniste",
    lat: 49.776,
    lng: 14.648,
    address: "Zámek Jemniště 1, 257 01 Postupice",
    startedAt: "2026-07-18T11:00:00Z",
    endedAt: "2026-07-18T16:00:00Z",
    category: "kultura",
    subcategory: "festivaly",
    tags: ["tradice", "venku"],
    status: "approved",
  ...
  {
    id: "evt-svet-ocima-tvurcu-teptina",
    type: "akce",
    slug: "svet-ocima-tvurcu-teptina",
    title: "Svět očima tvůrců z Těptína",
    description:
      "Výstava výtvarných prací dětí z 1. až 6. třídy Těptína v Kulturním centru Kamenice, otevřená do 31. srpna 2026.",
    href: "/akce/svet-ocima-tvurcu-teptina",
    lat: 49.8565,
    lng: 14.4948,
    address: "KC Kamenice, Ringhofferovo nám. 434, Kamenice",
    startedAt: "2026-04-09T00:00:00Z",
    endedAt: "2026-08-31T23:59:59Z",
    category: "kultura",
    subcategory: "vystavy",
    tags: ["pro-deti", "vytvarne"],
    status: "approved",
    trustLevel: "scraped",
  },
  {
    id: "evt-nejvetsi-zahady-tajemstvi-sveta-lesany",
    type: "akce",
    slug: "nejvetsi-zahady-tajemstvi-sveta-lesany",
    title: "Největší záhady a tajemství světa",
    description:
      "Putovní výstava o světových záhadách na zámku Lešany, otevřená do 28. září 2026. K vidění je replika křišťálové lebky Mitchella-Hedgese, kopie Turínského plátna a další exponáty, k dispozici jsou interaktivní prvky pro děti.",
    href: "/akce/nejvetsi-zahady-tajemstvi-sveta-lesany",
    lat: 49.7847,
    lng: 14.4944,
    address: "Zámek Lešany, Lešany 100, 257 44 Lešany",
    startedAt: "2026-06-17T00:00:00Z",
    endedAt: "2026-09-28T23:59:59Z",
    category: "kultura",
    subcategory: "vystavy",
    tags: ["pro-deti", "naucne"],
    status: "approved",
    trustLevel: "scraped",
  },
  {
    id: "evt-beneficni-street-food-festival-porici-2026-09-19",
    type: "akce",
    slug: "beneficni-street-food-festival-porici-2026-09-19",
    title: "Benefiční Street Food Festival Poříčí",
    description:
      "Čtvrtý ročník benefičního street food festivalu se stánky s jídlem a živou hudbou v Poříčí nad Sázavou.",
    href: "/akce/beneficni-street-food-festival-porici-2026-09-19",
    website: "https://vikendo.cz/events/beneficni-street-food-festival-porici-nad-sazavou",
    lat: 49.845,
    lng: 14.685,
    address: "Na Rubši 465, 257 21 Poříčí nad Sázavou",
    startedAt: "2026-09-19T11:00:00Z",
    endedAt: "2026-09-19T22:00:00Z",
    category: "zabava",
    subcategory: "jarmarky",
    tags: ["pro-rodiny", "pro-skupiny"],
    status: "approved",
    trustLevel: "scraped",
  },
  {
    id: "evt-vinny-kost-festival-chuti-benesov-2026-10-03",
    type: "akce",
    slug: "vinny-kost-festival-chuti-benesov-2026-10-03",
    title: "Vinný košt a festival chutí v Benešově",
    description:
      "Festival vína s degustacemi vinařství, stánky s delikatesami a živou hudbou na Masarykově náměstí v Benešově.",
    href: "/akce/vinny-kost-festival-chuti-benesov-2026-10-03",
    website: "https://vikendo.cz/events/vinny-kost-festival-chuti-v-benesove",
    lat: 49.7844,
    lng: 14.6848,
    address: "Masarykovo náměstí 226, Benešov",
    startedAt: "2026-10-03T10:00:00Z",
    endedAt: "2026-10-03T20:00:00Z",
    category: "zabava",
    subcategory: "jarmarky",
    tags: ["pro-rodiny", "pro-skupiny"],
    status: "approved",
...
const directory: Entry[] = [
  ...
  // ─── NOVÉ ZÁZNAMY — Firecrawl deep-search 2026-07-12 (cache mining + živý scrape, viz staging/harvest-2026-07-12.json) ───
  {
    ...
    type: "obchody",
    slug: "coop",
    title: "COOP Chrást nad Sázavou",
    description:
      "Prodejna smíšeného zboží a potravin COOP v Chrástu nad Sázavou.",
    href: "/mista/coop",
    lat: 49.846722,
    lng: 14.553797,
    address: "Chrást nad Sázavou 243",
    category: "potraviny-napoje",
    subcategory: "samoobsluhy",
    status: "approved",
    trustLevel: "scraped",
  },
  {
    ...
    title: "U Toničky",
    description:
      "Restaurace s českou kuchyní v Chrástu nad Sázavou.",
    href: "/mista/u-tonicky",
    lat: 49.846665,
    lng: 14.554293,
    address: "Chrást nad Sázavou 44",
    category: "restaurace",
    subcategory: "ceska-kuchyne",
    status: "approved",
    trustLevel: "scraped",
  ...
  {
    id: "pl-sokolovna-zboreny-kostelec",
    type: "mista",
    slug: "sokolovna-zboreny-kostelec",
    title: "Sokolovna Zbořený Kostelec",
    description:
      "Sokolovna v lokalitě Zbořený Kostelec sloužící pro sport a společenské akce.",
    href: "/mista/sokolovna-zboreny-kostelec",
    lat: 49.850936,
    lng: 14.592406,
    address: "Zbořený Kostelec 82",
    category: "sport",
    subcategory: "sportoviste",
    status: "approved",
    trustLevel: "scraped",
  },
  {
    ...
    title: "U Holubů",
    description:
      "Hospoda v Peceradech, otevřeno denně od 16 do 21 hodin.",
    href: "/mista/u-holubu",
    lat: 49.849433,
    lng: 14.594895,
    address: "Pecerady 172",
  ...
  {
    id: "sv-zs-tynec-nad-sazavou",
    type: "sluzby",
    slug: "zs-tynec-nad-sazavou",
    title: "Základní škola Týnec nad Sázavou",
    description:
      "Základní škola v Týnci nad Sázavou.",
    href: "/sluzby/zs-tynec-nad-sazavou",
    website: "https://www.zstynec.cz/",
    lat: 49.83745,
    lng: 14.588594,
    category: "vzdelavani",
    subcategory: "zakladni-skola",
  ...
  {
    id: "pl-u-adenauera-na-zastavce",
    type: "gastro",
    slug: "u-adenauera-na-zastavce",
    title: "U Adenauera, Na Zastávce",
    description:
      "Restaurace U Adenauera (Na Zastávce) severozápadně od Krhanic.",
    href: "/mista/u-adenauera-na-zastavce",
    lat: 49.866315,
    lng: 14.516958,
    category: "restaurace",
    subcategory: "ceska-kuchyne",
  ...
  },
  {
    ...
    title: "Brooklyn",
    description:
      "Restaurace Brooklyn v Týnci nad Sázavou v ulici Družstevní.",
    href: "/mista/brooklyn",
    lat: 49.835804,
    lng: 14.588088,
    address: "Družstevní 532, Týnec nad Sázavou",
    category: "restaurace",
    status: "approved",
    trustLevel: "scraped",
  },
  {
    id: "pl-lekarna-poliklinika-tynec",
    type: "obchody",
    slug: "lekarna-poliklinika-tynec",
    title: "Lékárna, Městská poliklinika Týnec",
    description:
      "Lékárna v budově městské polikliniky v Týnci nad Sázavou na náměstí SNP.",
    href: "/mista/lekarna-poliklinika-tynec",
    lat: 49.837525,
    lng: 14.588425,
    address: "Náměstí SNP 34, Týnec nad Sázavou",
    category: "specializovane",
    subcategory: "lekarna",
    status: "approved",
    trustLevel: "scraped",
  },
  {
    ...
    title: "Lékárna Alba",
    description:
      "Lékárna Alba v Týnci nad Sázavou.",
    href: "/mista/lekarna-alba",
    lat: 49.831233,
    lng: 14.569865,
    category: "specializovane",
    subcategory: "lekarna",
  ...
  {
    id: "sv-zdravotnicke-stredisko-tynec",
    type: "sluzby",
    slug: "zdravotnicke-stredisko-tynec",
    title: "Zdravotnické středisko Týnec",
    description:
      "Zdravotnické středisko v Týnci nad Sázavou s ordinacemi praktických lékařů.",
    href: "/sluzby/zdravotnicke-stredisko-tynec",
    lat: 49.829585,
    lng: 14.565733,
    category: "zdravi",
    subcategory: "prakticky-lekar",
  ...
  {
    id: "sv-zubni-ordinace-tynec",
    type: "sluzby",
    slug: "zubni-ordinace-tynec",
    title: "Zubní ordinace Týnec",
    description:
      "Zubní ordinace v Týnci nad Sázavou.",
    href: "/sluzby/zubni-ordinace-tynec",
    lat: 49.836389,
    lng: 14.588139,
    category: "zdravi",
    subcategory: "zubar",
  ...
  {
    id: "pl-pomnik-padlych-tynec",
    type: "mista",
    slug: "pomnik-padlych-tynec",
    title: "Pomník padlým ve světových válkách",
    description:
      "Pomník obětem světových válek v Týnci nad Sázavou.",
    href: "/mista/pomnik-padlych-tynec",
    lat: 49.836,
    lng: 14.588,
    category: "pamatky",
    subcategory: "pomniky-sochy",
    status: "approved",
    trustLevel: "scraped",
  },
  {
    id: "pl-knihovna-tynec",
    type: "mista",
    slug: "knihovna-tynec",
    title: "Knihovna Týnec nad Sázavou",
    description:
      "Veřejná knihovna v Týnci nad Sázavou při Kulturním centru.",
    href: "/mista/knihovna-tynec",
    lat: 49.8369,
    lng: 14.5949,
    category: "kultura",
    subcategory: "knihovny",
  ...
  {
    id: "pl-detske-hriste-tynec",
    type: "mista",
    slug: "detske-hriste-tynec",
    title: "Dětské hřiště Týnec",
    description:
      "Veřejné dětské hřiště v Týnci nad Sázavou.",
    href: "/mista/detske-hriste-tynec",
    lat: 49.834,
    lng: 14.596,
    category: "rekreace",
    subcategory: "detska-hriste",
  ...
  {
    id: "pl-detske-hriste-podhorky",
    type: "mista",
    slug: "detske-hriste-podhorky",
    title: "Dětské hřiště Podhorky",
    description:
      "Dětské hřiště v lokalitě Podhorky u Týnce nad Sázavou.",
    href: "/mista/detske-hriste-podhorky",
    lat: 49.825,
    lng: 14.593,
    category: "rekreace",
    subcategory: "detska-hriste",
  ...
  {
    id: "pl-workout-hriste-bozkov",
    type: "mista",
    slug: "workout-hriste-bozkov",
    title: "Workoutové a dětské hřiště Božkov",
    description:
      "Workoutové a dětské hřiště v lokalitě Božkov u Týnce nad Sázavou.",
    href: "/mista/workout-hriste-bozkov",
    lat: 49.815,
    lng: 14.596,
    category: "rekreace",
    subcategory: "workout",
  ...
  {
    id: "pl-tk-tynec-nad-sazavou",
    type: "mista",
    slug: "tk-tynec-nad-sazavou",
    title: "Tenisový klub Týnec nad Sázavou",
    description:
      "Tenisové kurty v Týnci nad Sázavou.",
    href: "/mista/tk-tynec-nad-sazavou",
    lat: 49.832,
    lng: 14.594,
    category: "sport",
    subcategory: "sportoviste",
  ...
  {
    id: "pl-viceucelnove-sportoviste-tynec",
    type: "mista",
    slug: "viceucelnove-sportoviste-tynec",
    title: "Víceúčelové sportoviště Týnec",
    description:
      "Sportovní areál v Týnci nad Sázavou s víceúčelovým hřištěm.",
    href: "/mista/viceucelnove-sportoviste-tynec",
    lat: 49.826,
    lng: 14.598,
    category: "sport",
    subcategory: "sportoviste",
  ...
  {
    id: "pl-cyklostezka-do-krnan",
    type: "mista",
    slug: "cyklostezka-do-krnan",
    title: "Cyklostezka do Krňan",
    description:
      "Cyklotrasa spojující okolí Krhanic s obcí Krňany.",
    href: "/mista/cyklostezka-do-krnan",
    category: "sport",
    subcategory: "cyklotrasy",
    status: "approved",
    trustLevel: "scraped",
  },
  {
    ...
    title: "Panská skála",
    description:
      "Skalní vyhlídka Panská skála v okolí Krhanic.",
    href: "/mista/panska-skala",
    lat: 49.87,
    lng: 14.443,
    category: "priroda-krajina",
    subcategory: "vyhlidky",
  ...
  {
    id: "pl-zampasska-vyhlidka",
    type: "mista",
    slug: "zampasska-vyhlidka",
    title: "Žampašská vyhlídka",
    description:
      "Vyhlídka v okolí Žampachu nad údolím Sázavy.",
    href: "/mista/zampasska-vyhlidka",
    lat: 49.84,
    lng: 14.43,
    category: "priroda-krajina",
    subcategory: "vyhlidky",
  ...
  {
    id: "pl-tvrz-prosecnice",
    type: "mista",
    slug: "tvrz-prosecnice",
    title: "Tvrz Prosečnice",
    description:
      "Pozůstatky tvrze v Prosečnici, místní části obce Krhanice.",
    href: "/mista/tvrz-prosecnice",
    lat: 49.794,
    lng: 14.589,
    inVillage: true,
    category: "pamatky",
  ...
  {
    id: "pl-andrago-winery",
    type: "obchody",
    slug: "andrago-winery",
    title: "Andrago Winery",
    description:
      "Vinařství Andrago jihozápadně od Krhanic.",
    href: "/mista/andrago-winery",
    lat: 49.814,
    lng: 14.431,
    category: "potraviny-napoje",
    subcategory: "vinoteky",
  ...
  {
    id: "pl-stola-sv-antonina-paduanskeho",
    type: "mista",
    slug: "stola-sv-antonina-paduanskeho",
    title: "Štola sv. Antonína Paduánského",
    description:
      "Historické důlní dílo z let 1753 až 1754 na těžbu zlata v jílovském zlatonosném revíru. Technická památka nedaleko Jílového u Prahy.",
    href: "/mista/stola-sv-antonina-paduanskeho",
    website: "https://www.navylet.cz/cs/cil/stola-sv-antonina-paduanskeho-jilove-u-prahy",
    lat: 49.89479,
    lng: 14.49325,
  ...
  {
    id: "pl-bar-masna-tynec",
    type: "gastro",
    slug: "bar-masna-tynec",
    title: "Bar Masna Týnec",
    description:
      "Bar a vinotéka v Týnci nad Sázavou. Otevřeno hlavně od večera, o víkendu do nočních hodin.",
    href: "/mista/bar-masna-tynec",
    website: "https://www.instagram.com/barmasnatynec/",
    lat: 49.83068497,
    lng: 14.59130384,
    address: "Pod Hradištěm 72, 257 41 Týnec nad Sázavou",
    hours: "Po až Pá 17:00–24:00, So 15:00–03:00, Ne 15:00–22:00",
    category: "hospody-bary",
    subcategory: "bary",
    status: "approved",
    trustLevel: "scraped",
    contactEmail: "tomastrojanekk@seznam.cz",
  },
  {
    id: "pl-mlyn-brejlov",
    type: "mista",
    ...
    title: "Mlýn Brejlov",
    description:
      "Penzion na břehu řeky Sázavy s ubytováním v pokojích i chatách, vlastní restaurací, ohništěm a dětským hřištěm.",
    href: "/mista/mlyn-brejlov",
    website: "https://www.mlynbrejlov.cz/",
    lat: 49.844,
    lng: 14.5,
    address: "Břežany 29, Lešany",
    category: "rekreace",
    status: "approved",
    trustLevel: "scraped",
  },
  {
    id: "pl-posazavska-hospoda-stodola",
    type: "gastro",
    slug: "posazavska-hospoda-stodola",
    title: "Posázavská hospoda STODOLA",
    description:
      "Restaurace s tradiční českou kuchyní v Rakousích nedaleko Jílového u Prahy, s výhledem na Žampašský most. Nabízí obědy, večeře a venkovní posezení.",
    href: "/mista/posazavska-hospoda-stodola",
    website: "https://posazavskastodola-cz.webnode.cz/menu/",
    lat: 49.863674,
    lng: 14.478957,
    address: "Rakousy 143, 254 01 Jílové u Prahy",
    hours: "denně",
    category: "restaurace",
    subcategory: "ceska-kuchyne",
    tags: ["parkovani", "pro-rodiny"],
    status: "approved",
    trustLevel: "scraped",
    contactEmail: "velkarodina.s@seznam.cz",
    contactPhone: "+420 224 241 400",
  },
];
